...
#define STRING_CONFIG_H_AUTHOR "(DIY, P3Steel)" //Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lore"
...
#define TEMP_SENSOR_0 1		// my printer had a shorted thermistor at the nozzle.  They over crimped the brass insert.
...
#define UNIFIED_BED_LEVELING_GRID_POINTS 5 	// Max size of the n x n grid to be probed
  ...
  #define MESH_NUM_X_POINTS 4  // Don't use more than 15 points per axis
...
#define HOMING_FEEDRATE {40*60, 50*60, 3*50, 0}  // set the homing speeds (mm/min)
...
//
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,2560,285}      // default steps per unit for FolgerTech i3-2020
#define DEFAULT_MAX_FEEDRATE          {250, 250, 10, 17}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,25,750}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
